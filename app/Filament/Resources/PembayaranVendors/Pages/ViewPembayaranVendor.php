...
class ViewPembayaranVendor extends ViewRecord
{
            ...
            Section::make('Informasi Pembayaran')
                ...
                ->schema([
                    ...
                    TextEntry::make('tanggal_faktur')
                        ...
                        ->state(
                            $this->record->penjualan?->tanggal_faktur
                        )
                ...
                ->schema([
                    ...
                    TextEntry::make('total_bayar')
                        ...
                        ->state(
                            ...
                            ?? (
                                $this->record->jumlah_bayar
                                - ($this->record->diskon_termin ?? 0)
                            )
                        )
                    ...
                    TextEntry::make('sisa_piutang')
                        ...
                        ->state(
                            $this->record->keterangan === 'lunas'
                                ? 0
                                : (
                                    $this->record->piutang?->sisa_piutang
                                    ?? $this->record->jumlah_bayar
                                )
                        )
